...
class BS4_NEWS_COMPANY_CRAWL_DATA(models.Model):
    COMPANY_CODE = models.CharField(db_index=True, max_length=200)
    DOMAIN_URL = models.TextField(blank=True)
    DOMAIN_QUERY_STRING = models.TextField(blank=True)
    TARGET_CRAWL_URL = models.CharField(db_index=True, max_length=300)
    TARGET_RAW_HTML_DATA = models.TextField(blank=True)
    UPDATE_DATETIME = models.DateTimeField('date updated')
    UPDATE_USER = models.CharField(db_index=True, max_length=200)
    CREATE_DATETIME = models.DateTimeField('date created')
    CREATE_USER = models.CharField(db_index=True, max_length=200)
...
class BS4_NEWS_COMPANY_CRAWL_RESULT(models.Model):
    COMPANY_CODE = models.CharField(db_index=True, max_length=200)
    DOMAIN_URL = models.TextField(blank=True)
    DOMAIN_QUERY_STRING = models.TextField(blank=True)
    EXECUTE_DATE = models.DateTimeField('date executed')
    EXECUTE_RESULT = models.CharField(db_index=True, max_length=200)
    EXECUTE_RESULT_COUNT = models.TextField(blank=True)
    EXECUTE_RESULT_SUCCESS = models.TextField(blank=True)
    EXECUTE_RESULT_FAIL = models.TextField(blank=True)
    UPDATE_DATETIME = models.DateTimeField('date updated')
    UPDATE_USER = models.CharField(db_index=True, max_length=200)
    CREATE_DATETIME = models.DateTimeField('date created')
    CREATE_USER = models.CharField(db_index=True, max_length=200)
...
class BS4_NEWS_COMPANY_SCRAP_RESULT(models.Model):
    COMPANY_CODE = models.CharField(db_index=True, max_length=200)
    DOMAIN_URL = models.TextField(blank=True)
    DOMAIN_QUERY_STRING = models.TextField(blank=True)
    TARGET_CRAWL_URL = models.CharField(db_index=True, max_length=300)
